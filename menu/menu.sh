#!/bin/bash
BURIQ () {
    curl -sS https://raw.githubusercontent.com/premium02/permission/main/ipmini > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/premium02/permission/main/ipmini | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/premium02/permission/main/ipmini | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
Exp=$(curl -sS https://raw.githubusercontent.com/premium02/permission/main/ipmini | grep $MYIP | awk '{print $3}')
fi
...
export sem=$( curl -s https://raw.githubusercontent.com/premium02/permission/main/versions)
...
6969) clear ; wget https://raw.githubusercontent.com/premium02/install/main/update.sh && chmod +x update.sh && ./update.sh && rm -f /root/update.sh ;;
11) clear ; cf ;;
12) clear ; up ;;
13) clear ; slow ;;
14) clear ; clearcache ;;
